...
import com.example.nghincukhoahc.databinding.ActivityAdminChat2Binding;
import com.example.nghincukhoahc.databinding.ActivityAdminChatBinding;
...
public class AdminChatActivity extends BaseActivity {
    ...
    private ActivityAdminChat2Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityAdminChat2Binding.inflate(getLayoutInflater());
        ...
        ApiClient.getClient().create(ApiService.class).sendMessage(
            ...
            public void onResponse(@NonNull Call<String> call,@NonNull Response<String> response) {
                if(response.isSuccessful()){
                    ...
                    showToast("Notifycation sent successfully");
    ...
    private void listenAvailabilityOfReceiver(){
        databse.collection(Constants.KEY_COLLECTION_USERS).document(
                receiverUser.id
        ).addSnapshotListener(AdminChatActivity.this,(value, error) -> {
            if(error != null){
                return;
            }
            if(value != null){
    ...
    private void setListeners(){
        binding.imageBack.setOnClickListener(v -> {
            Intent intent = new Intent(AdminChatActivity.this,AdminChat.class);
    ...
    private void updateConversion(String message){
        DocumentReference documentReference = databse.collection(Constants.KEY_COLLECTION_CONVERSATIONS).document(conversionId);
